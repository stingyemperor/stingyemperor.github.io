...
function initGameState(gameState){
    ...
    gameState.sphereMaterial = [Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY , -2.3, -2.3,0.0,0.0, 0.0 ,Number.NEGATIVE_INFINITY, 0.05 , 0.5 ];

    // gameState.planeCenterRadius[0.0,1.0,-6.0,100.0];
    // gameState.planeColor[1.0,0.0,0.0];
    // gameState.planeMaterial = [Number.NEGATIVE_INFINITY, 0.0 , -2.3, -2.3,0.0,0.0, 0.0 ,Number.NEGATIVE_INFINITY, 0.05 , 0.5 ];
...
function createTexture(myImage){

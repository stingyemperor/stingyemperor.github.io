...
sampleButtons = function()
{
	...
	exampleButtons.on("click", function() {
		...
		if($(this).text() ==="New-1")
		{
			...
			//new
			alphaR = 1;
			image1.src = linkPrefix + "images/new/dark.PNG";//dark
			image2.src = linkPrefix + "images/new/light.PNG";//bright
			image3.src = linkPrefix + "images/new/normal.PNG"; //shape map
			image4.src = linkPrefix + "images/dark.png";  //reflection
			image5.src = linkPrefix + "images/dark.jpg";  //refraction	
			image6.src = linkPrefix + "images/white.png"; //alpha
		...
		if($(this).text() ==="New-2")
		{
			...
			//new
			alphaR = 1;
			image1.src = linkPrefix + "images/new/dark2.PNG";//dark
			image2.src = linkPrefix + "images/new/light2.PNG";//bright
			image3.src = linkPrefix + "images/new/normal2.PNG"; //shape map
			image4.src = linkPrefix + "images/dark.png";  //reflection
			image5.src = linkPrefix + "images/dark.jpg";  //refraction	
			image6.src = linkPrefix + "images/white.png"; //alpha
...
UPLOADinit = function()
{
	...
	// image6.src = "images/1/alpha-1.png"; //alpha
